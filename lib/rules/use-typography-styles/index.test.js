...
it('gives an error when setting font size', async () => {
  ...
  expect(warnings[0].text).toBe(
    'You should not declare your own `font-size`. Use a Backpack mixin instead. (backpack/use-typography-styles)',
  );
});
...
it('gives an error when using typography tokens', async () => {
  ...
  expect(warnings[0].text).toBe(
    'You should not declare your own `font-weight`. Use a Backpack mixin instead. (backpack/use-typography-styles)',
  );
});
...
it('gives an error when using font shorthand', async () => {
  ...
  expect(warnings[0].text).toBe(
    'You should not declare your own `font`. Use a Backpack mixin instead. (backpack/use-typography-styles)',
  );
});
